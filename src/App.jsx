...
const LOCALE_DATA = {
  en: {
    ...
    home: { title: "Scan Medicine", capture: "Capture Photo", upload: "Gallery Upload", recentScans: "Your Collection", analyzing: "Consulting nature's archives...", greeting: "Good Day" },
...
export default function MedScanApp() {
  ...
  const callBackendAPI = async (promptText, base64Image) => {
    ...
    // Default Production Path: Call Vercel Backend
  ...
  const translateCurrentScan = async (fullImageUri, scanId) => {
    ...
    try {
      // Remove data prefix for the API call if your backend expects raw base64
      const rawBase64 = fullImageUri.split(',')[1];
...
-- Scanned with CocoMed
  ...
  const analyzeMedicine = async (base64Image) => {
    ...
    try {
      // Call our secure Vercel backend
