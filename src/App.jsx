...
const LOCALE_DATA = {
  en: {
    ...
    help: { title: "How it Works", step1: "Snap a Photo", step1Desc: "Ensure good lighting and hold steady.", step2: "AI Analysis", step2Desc: "Our engine identifies the medicine.", step3: "Get Insights", step3Desc: "Read dosage, usage, and warnings in your language.", safetyTitle: "Safety First", safetyDesc: "CocoMed uses AI to read labels, but it does not replace your doctor. Always double-check with a professional." }
  },
  ta: {
  ...
  const HelpScreen = () => (
    <div className="flex-1 p-6 md:p-12 max-w-5xl mx-auto w-full">
       <div className="text-center mb-12">
         ...
         <p className="text-slate-500 text-lg max-w-2xl mx-auto">Use AI to instantly understand your medication. It's safe, private, and easy.</p>
       </div>
    ...
    <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto w-full p-6 md:p-12 items-center">
      <div className="w-full md:w-5/12 flex flex-col">
         ...
         <div className="mb-8 pl-4">
           ...
           <p className="text-slate-500 font-medium text-lg leading-relaxed border-l-4 border-emerald-200 pl-4">Instant identification to help you stay informed.</p>
         </div>
